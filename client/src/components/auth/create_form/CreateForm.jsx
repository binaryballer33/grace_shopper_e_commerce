...
const CreateForm = ({
  ...
  function getMutationFunctionAndState(formType) {
    switch (formType) {
      ...
      default:
        throw new Error(`Invalid formType: ${formType}, Can't Create Form`);
    }
  }
      ...
      >
        ...
        <Paper
          ...
          sx={{
            ...
            gap: 2,
            width: props.width ? props.width : { xs: 250, sm: 500, md: 800 },
            height:
        ...
        >
          ...
          {arrayOfTextFields.map((textfield) => {
            const transformedTextField = transformTextField(textfield);
            return (
              <TextField
                key={textfield}
