...
export const PRODUCT_DATA = [
  ...
  {
    name: "Banana",
    description: "Bananas are a versatile, yellow fruit with a mild flavor.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Grapes",
    description: "Grapes come in clusters and can be red, green, or purple.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Mango",
    description: "Mangoes are tropical fruits with a sweet and juicy taste.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  {
    name: "Pineapple",
    description: "Pineapples have a spiky exterior and sweet, tropical flavor.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Plum",
    description: "Plums are smooth-skinned fruits with sweet and juicy flesh.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Lemon",
    description: "Lemons are sour citrus fruits commonly used for their juice.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Rambutan",
    description: "Rambutans are hairy fruits with sweet, translucent flesh.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
  ...
  {
    name: "Lychee",
    description: "Lychees are small, red fruits with translucent, juicy flesh.",
    image: IMG_URL,
    price: randomNumberBetweeen(1, 20),
    count: randomNumberBetweeen(1, 50),
  },
